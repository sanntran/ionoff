...
class Ep2RelayDriverThread extends AbstractRelayDriverThread {

	Ep2RelayDriverThread(Long relayDriverId,
	...
	@Override
	protected void scanRelayDriverStatus() throws RelayDriverException, 
					UnknownRelayDriverModelException, RelayDriverNotFoundException {
