...
public class ControllerConnection extends Observable implements Runnable {
	...
	public ControllerConnection(Socket socket, Observer ...observers) throws IOException {
		this.socket = socket;
