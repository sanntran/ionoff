...
public class Controller extends BaseObj {
	...
	public boolean isConnected() {
		...
		if (ControllerModel.IONOFF_P4.toString().equals(model) 
		...
		else if (ControllerModel.HBQ_EC100.toString().equals(model) 
				|| ControllerModel.HLAB_EP2.toString().equals(model)) {
	...
	public ControllerModel getModelObj() {
		return ControllerModel.fromString(model);
	}
