...
public class FileManager {
	...
	public static List<String> unzipFile(String downloadedFile, String toFolder) throws IOException {
		return unzip(downloadedFile, UpdatorConfig.getInstance().LOCAL_UPDATE_FOLDER);
	}
	 ...
	 * @throws IOException
	 */
	private static List<String> unzip(String zipFilePath, String destDirectory) throws IOException {
