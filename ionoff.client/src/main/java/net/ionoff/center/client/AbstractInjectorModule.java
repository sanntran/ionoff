...
public class AbstractInjectorModule extends AbstractGinModule {
	...
	public static class SensorDataServiceProvider implements Provider<SensorDataService> {
		@Override
		public SensorDataService get() {
			final SensorDataService service = GWT.create(SensorDataService.class);
			setRestServiceProxyResource(service);
			return service;
		}
	}
