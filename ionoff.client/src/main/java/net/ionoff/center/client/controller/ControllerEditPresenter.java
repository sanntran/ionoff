...
public class ControllerEditPresenter extends AbstractEditPresenter<ControllerDto> {
	...
	protected void bind() {
		...
		view.getListBoxModels().addValueChangeHandler(new ValueChangeHandler<String>() {
			...
			public void onValueChange(ValueChangeEvent<String> event) {
				...
				if (ControllerModel.IONOFF_E3.toString().equals(model) ||
						ControllerModel.IONOFF_E4.toString().equals(model) ||
	...
	private void updateView(ControllerDto dto) {
		...
		if (ControllerModel.IONOFF_E3.equals(dto.getModel())  ||
				ControllerModel.IONOFF_E4.equals(dto.getModel()) ||
