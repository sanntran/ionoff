...
class TcpServer extends Thread {
	...
	P4Config sendReqGetConf(String pw) throws Exception {
		TcpConnection conn = getTcpConnection(pw);
		if (conn == null) {
			throw new Exception("No connection or connection expired");
		}
	...
	P4Config sendReqConfigIp(String newIp, String pw) throws Exception {
		TcpConnection conn = getTcpConnection(pw);
		if (conn == null) {
			throw new Exception("No connection or connection expired");
		}
	...
	P4Config sendReqConfigSubnetMask(String newSubnet, String pw) throws Exception {
		TcpConnection conn = getTcpConnection(pw);
		if (conn == null) {
			throw new Exception("No connection or connection expired");
		}
	...
	P4Config sendReqConfigGateway(String newGateway, String pw) throws Exception {
		TcpConnection conn = getTcpConnection(pw);
		if (conn == null) {
			throw new Exception("No connection or connection expired");
		}
	...
	P4Config sendReqConfigSrvIp(String newSrvIp, String pw) throws Exception {
		TcpConnection conn = getTcpConnection(pw);
		if (conn == null) {
			throw new Exception("No connection or connection expired");
		}
	...
	P4Config sendReqConfigMac(String newMac, String pw) throws Exception {
		TcpConnection conn = getTcpConnection(pw);
		if (conn == null) {
			throw new Exception("No connection or connection expired");
		}
	...
	P4Config sendReqConfigInputTypes(List<Integer> newInputTypes, String pw) throws Exception {
		TcpConnection conn = getTcpConnection(pw);
		if (conn == null) {
			throw new Exception("No connection or connection expired");
		}
