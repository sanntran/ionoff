...
public class P4Tool extends JFrame {
	...
	boolean validateIp() {
		return P4Config.validateIp(ipTextField.getText());
	}
	
	boolean validatePw() {
		return P4Config.validatePw(pwTextField.getText());
	}
