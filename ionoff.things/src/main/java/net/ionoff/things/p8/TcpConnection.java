...
class TcpConnection {
	...
	P8Config sendReqConfigInputTypes(List<Integer> newInputTypes) throws Exception {
		String inputTypes = "";
	...
	P8Config sendReqConfigSrvIp(String newSrvIp) throws Exception {
		String reqStr = new TcpRequest().setCfObj().setSetMethod()
	...
	P8Config sendReqConfigIp(String newIp) throws Exception {
		String reqStr = new TcpRequest().setCfObj().setSetMethod()
	...
	P8Config sendReqConfigSubnetMask(String newSubnetMask) throws Exception {
		String reqStr = new TcpRequest().setCfObj().setSetMethod()
	...
	P8Config sendReqConfigGateway(String newGateway) throws Exception {
		String reqStr = new TcpRequest().setCfObj().setSetMethod()
	...
	P8Config sendReqConfigMac(String newMac) throws Exception {
		String reqStr = new TcpRequest().setCfObj().setSetMethod()
	...
	P8Config sendReqGetConf() throws Exception {
	...
	private P8Config parseConfig(String configStr) {
		if (configStr == null) {
